...
- **home-manager**: init gitui module by [@sophieforrest](https://github.com/sophieforrest)
...
- **home-manager**: make dark/light lowecase for style names in gtk by [@selfuryon](https://github.com/selfuryon)
...
- **home-manager**: assert `qt.platformTheme.name` for kvantum by [@pinkcreeper100](https://github.com/pinkcreeper100)
...
- update docs for by (@github-actions[bot])
...
- **release-please**: use action from googleapis by [@sgoudham](https://github.com/sgoudham)
...
- remove unused argument in mk-site.nix by [@pinkcreeper100](https://github.com/pinkcreeper100)
...
* [@pinkcreeper100](https://github.com/pinkcreeper100) made their first contribution in [#245](https://github.com/catppuccin/nix/issues/245)
...
* [@sophieforrest](https://github.com/sophieforrest) made their first contribution in [#98](https://github.com/catppuccin/nix/issues/98)
